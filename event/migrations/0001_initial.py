    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ready_to_distribute', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], default='no', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Person',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(blank=True, default=1, on_delete=django.db.models.deletion.CASCADE, to='event.event')),
                ('person', models.ForeignKey(blank=True, default=1, on_delete=django.db.models.deletion.CASCADE, to='event.person')),
